...
class DQN(nn.Module):
    def __init__(self, state_dim, action_dim):
        ...
        self.fc21 = nn.Linear(20, 1)  # for value function
        self.fc22 = nn.Linear(20, action_dim)  # for advantage function

    def forward(self, x):
        x = F.relu(self.fc1(x))
        V = self.fc21(x)  # value function
        A = self.fc22(x)  # advantage function
